...
ActiveRecord::Schema.define(version: 20161205191949) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "bookforpms", force: :cascade do |t|
    t.integer  "passengerride_id"
    t.integer  "customer_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["customer_id"], name: "index_bookforpms_on_customer_id", using: :btree
    t.index ["passengerride_id"], name: "index_bookforpms_on_passengerride_id", using: :btree
  end
